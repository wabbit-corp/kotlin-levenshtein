 ...
 */
inline fun lcsCommon(lhsSize: Int, rhsSize: Int, crossinline isEqual: (Int, Int) -> Boolean): Int {
 ...
 *
 * @return Pair( lengthOfLCS, listOfOperations ) Where 'listOfOperations' is from first to last in a
 *   backtrack sense (we'll reverse at the end).
 */
fun lcsWithPath(
    lhs: CharSequence,
    rhs: CharSequence,
