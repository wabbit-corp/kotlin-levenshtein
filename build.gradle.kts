...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-levenshtein", "1.2.0")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-levenshtein")
        description.set("kotlin-levenshtein")
        url.set("https://github.com/wabbit-corp/kotlin-levenshtein")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-levenshtein")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-levenshtein.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-levenshtein.git")
        }
    }
}
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.levenshtein"
        compileSdk = 34
        minSdk = 26
    }
...
dokka {
    moduleName.set("kotlin-levenshtein")
    ...
    dokkaSourceSets.configureEach {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-levenshtein/tree/master/src")
